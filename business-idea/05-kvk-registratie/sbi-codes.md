...
## Actie
- [ ] Definitieve SBI-code(s) bevestigen via de KVK SBI-zoektool
      (sbi.cbs.nl) bij inschrijving — er worden maximaal 3 SBI-codes
      toegekend.
- [ ] Controleren of de gekozen code(s) gevolgen hebben voor vergunningen
      of verzekeringsplicht (zie `06-na-registratie/vergunningen.md`).

*Bron: kvk.nl (SBI-codes), overheidscijfers.nl.*
