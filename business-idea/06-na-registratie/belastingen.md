...
- **BTW**: verhuur van roerende zaken (zoals kleding) valt in Nederland
  ...
  KVK-inschrijving.
- **Inkomstenbelasting / vennootschapsbelasting**: afhankelijk van de
  gekozen rechtsvorm (zie `02-onderneming/rechtsvorm.md`) —
  eenmanszaak/VOF via de inkomstenbelasting (box 1, winst uit onderneming),
  BV via de vennootschapsbelasting.
- **Fiscale voordelen voor starters** (bij eenmanszaak/VOF, mits voldaan
  wordt aan het urencriterium):
  - Zelfstandigenaftrek
